...
<body class="bg-gray-100 text-gray-800">
    ...
    <div
        ...
        <div class="text-center mb-4">
            ...
            <p class="text-sm text-gray-500">Official Deposit Receipt</p>
        </div>

        <!-- Receipt Info -->
        <div class="space-y-2">
            <p><span class="font-semibold">User:</span> {{ $deposit->user->name }}</p>
        ...
        <div class="space-y-1">
            <p><span class="font-semibold">Date:</span>
                {{ \Carbon\Carbon::parse($deposit->deposited_on)->format('Y-m-d') }}
            </p>
            <p><span class="font-semibold">Time:</span>
                {{ \Carbon\Carbon::parse($deposit->deposited_on)->format('h:i A') }}
            </p>
        </div>
        ...
        <div class="text-center mt-6">
            <div class="inline-block bg-white p-2 rounded-lg shadow-md">
                ...
                "URL: " . url("/deposits/{$deposit->id}/print") . "\n" .
                "User: " . $deposit->user->name . "\n" .
                "Amount: $" . number_format($deposit->amount, 2) . "\n" .
                "Date: " . \Carbon\Carbon::parse($deposit->deposited_on)->format('Y-m-d') . "\n" .
                "Time: " . \Carbon\Carbon::parse($deposit->deposited_on)->format('h:i A') . "\n" .
