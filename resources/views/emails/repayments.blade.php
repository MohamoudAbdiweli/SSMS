...
<head>
    <meta charset="UTF-8">
    <title>Repayment Recorded</title>
</head>
                ...
                <table width="500" cellpadding="0" cellspacing="0"
                    ...
                    <tr>
                        <td style="background:#3b82f6; color:#ffffff; padding:20px; text-align:center;">
                            <h2 style="margin:0;">Repayment Recorded</h2>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding:20px; color:#333;">
                            ...
                            <p style="margin-bottom:10px;">
                                Hello <strong>{{ $repayment->user->name }}</strong>,
                            </p>

                            <p style="margin-bottom:20px;">
                                We have successfully received your repayment for your loan. Below are the details:
                            </p>
                            ...
                            <table width="100%" cellpadding="8" cellspacing="0"
                                ...
                                <tr>
                                    ...
                                    <td>{{ $repayment->loan->title ?? 'Loan #' . $repayment->loan->id }}</td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        {{ \Carbon\Carbon::parse($repayment->paid_on)->format('F d, Y - h:i A') }}
                                    </td>
                                </tr>
                                ...
                                <tr style="background:#f9fafb;">
                                    ...
                                    <td style="color:#dc2626; font-weight:bold;">
                                        ${{ number_format($repayment->loan->balance - $repayment->amount, 2) }}
                                    </td>
                                </tr>
                            ...
                            <p style="margin-top:20px;">
                                Thank you for keeping your loan in good standing.
                            </p>
